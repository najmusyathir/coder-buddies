        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl overflow-hidden shadow-lg flex flex-col gap-8 p-8">
            ...
            <div class="flex flex-col items-center gap-3 text-center">
                <h1 class="text-3xl text-orange-600 font-bold">
                    Belajar HTML dari Asas Hingga Mahir!
                </h1>
                <p>
                    HTML adalah bahasa asas yang digunakan untuk membina dan menyusun kandungan sesuatu laman web. Ia
                    berfungsi sebagai rangka yang mengatur teks, gambar, pautan, dan elemen lain supaya boleh dipaparkan
                    dengan betul oleh pelayar web. HTML bukan bahasa pengaturcaraan, tetapi bahasa markah yang
                    menggunakan tag untuk memberitahu pelayar bagaimana sesuatu kandungan harus ditunjukkan.
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-3 gap-5">
                        <template x-for="(card, idx) in cards" :key="idx">
                            <div @click="selectCard(idx)"
                                ...
                                <h3 class="text-xl font-semibold mb-1 text-orange-600"
